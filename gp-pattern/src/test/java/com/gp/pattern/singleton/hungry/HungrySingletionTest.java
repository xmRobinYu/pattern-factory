...
public class HungrySingletionTest {
    ...
    public void breakSingletonByReflectionTest() throws Exception {
        HungrySingletion singleton = HungrySingletion.getInstance();

        Constructor<HungrySingletion> constructor = HungrySingletion.class.getDeclaredConstructor();
        constructor.setAccessible(true);
        HungrySingletion singletonFromReflection = constructor.newInstance();
